            ...
            <>
              <div className="flex-1 overflow-y-auto pr-2 min-h-0">
                <div className="space-y-4">
                  {items.map((item) => (
                    <div key={item.variantId} className="flex gap-4 p-3 bg-card border border-border">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="font-mono text-sm mt-1">{item.price.currencyCode} {parseFloat(item.price.amount).toFixed(2)}</p>
                      </div>
              ...
              <div className="flex-shrink-0 space-y-4 pt-4 border-t border-border bg-background">
                <div className="flex justify-between items-center">
                  ...
                  <span className="font-mono text-xl">{items[0]?.price.currencyCode || '$'} {totalPrice.toFixed(2)}</span>
                </div>
