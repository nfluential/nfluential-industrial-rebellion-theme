    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section className="py-16 md:py-24 bg-background">
        <div className="container max-w-4xl">
          ...
          {/* Call to Action */}
          <div className="text-center py-12 md:py-20 border-t border-b border-border">
            <h2 className="font-display text-4xl md:text-6xl lg:text-7xl font-bold text-primary glow-eagles">
              ARE YOU NFLUENTIAL?
            </h2>
          </div>
